...
class Stack:
    ...
    def __init__(self, *items) -> None:
        self.store = Dequeue(*items)

    def __repr__(self) -> str:
        return "Stack: {}".format(self.store.get_items())

    def push(self, item: Any) -> None:
        """Push item on the top of the stack."""
        self.store.enqueue_head(item)

    def pop(self) -> Any:
        """Pop and return the head of the stack."""

        return self.store.dequeue_head()

    def peek(self) -> Any:
        """Peek and return the value in the head."""
        return self.store.peek_head()

    def get_count(self) -> int:
        """Return the count of the items in the stack."""
        return self.store.get_count()
