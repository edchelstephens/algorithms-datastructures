...
class Queue:
    ...
    def __repr__(self) -> str:
        return "Queue: {}".format(self.store.get_items())

    def enqueue(self, item: Any) -> None:
        """Add item to the tail of the queue."""
        self.store.enqueue_tail(item)

    def dequeue(self) -> None:
        """Remove item on the head of the queue."""
        self.store.dequeue_head()

    def peek(self) -> Any:
        """Peek and get the first item of the queue."""
